...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
   Describe allows you to group tests together. "It" is used for a single unit test.
1. What is the point of `Test Driven Development`? What do you think about this approach?
   The point is to make sure your code is good. When you have a large application, finding broken code can be impossible. It's a failsafe against bad code. I think it's good but someone needs to come up with a simpler way to test. Madness!

1. Mention three types of automated tests.
   unit testing, integration tests, snapshot testing and server testing, component testing
